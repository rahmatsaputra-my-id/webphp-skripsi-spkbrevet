                    ...
                    <div class="container-fluid">
                      ...
                      <div class="card mb-3">
                        <div class="card-header text-lg-left">
                          <a class="btn btn-success" href="<?php echo base_url('setting_alternatif') ?>"><i class="fa fa-arrow-left modal-icon"></i> Kembali</a>
                        </div>
                        <div class="card-body">

                          <form action="<?php echo base_url('setting_alternatif_tambah') ?>" method="post" enctype="multipart/form-data" >
                             ...
                             <div class="form-group text-lg-left"><!-- 
                              ...
                              <input class="form-control <?php echo form_error('id') ? 'is-invalid':'' ?>"
                               type="text" name="id" hidden placeholder="ID Alternatif" />
                             ...
                             <div class="form-group text-lg-left">
                              ...
                              <input class="form-control <?php echo form_error('nama_alternatif') ? 'is-invalid':'' ?>"
                               type="text" name="nama_alternatif" placeholder="Nama Alternatif" required="" />
                              <div class="invalid-feedback">
                                <?php echo form_error('name') ?>
                              </div>
                            </div>
                            ...
                            <div class="form-group text-lg-left">
                              ...
                              <input class="form-control <?php echo form_error('n1') ? 'is-invalid':'' ?>"
                               type="number" name="k1" min="1" max="100" placeholder="Nilai Kriteria K1" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              ...
                              <input class="form-control <?php echo form_error('n2') ? 'is-invalid':'' ?>"
                               type="number" name="k2" min="1" max="100" placeholder="Nilai Kriteria K2" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              ...
                              <input class="form-control <?php echo form_error('n3') ? 'is-invalid':'' ?>"
                               type="number" name="k3" min="1" max="100" placeholder="Nilai Kriteria K3" required=""/>
                              <div class="invalid-feedback">
                                <?php echo form_error('k3') ?>
                              </div>
                            </div>

                            <div class="form-group text-lg-left">
                              <label for="k4">K<sub>4</sub></label>
                              <input class="form-control <?php echo form_error('n4') ? 'is-invalid':'' ?>"
                               type="number" name="k4" min="1" max="100" placeholder="Nilai Kriteria K4" required=""/>
                              <div class="invalid-feedback">
                                <?php echo form_error('k4') ?>
                              </div>
                            </div>

                            <div class="form-group text-lg-left">
                              <label for="k5">K<sub>5</sub></label>
                              <input class="form-control <?php echo form_error('n5') ? 'is-invalid':'' ?>"
                               type="number" name="k5" min="1" max="100" placeholder="Nilai Kriteria K5" required=""/>
                              <div class="invalid-feedback">
                                <?php echo form_error('k5') ?>
                              </div>
                            </div>

                            <div class="form-group text-lg-left">
                              <label for="k6">K<sub>6</sub></label>
                              <input class="form-control <?php echo form_error('n6') ? 'is-invalid':'' ?>"
                               type="number" name="k6"min="1" max="100"  placeholder="Nilai Kriteria K6" required=""/>
                              <div class="invalid-feedback">
                                <?php echo form_error('k6') ?>
                              </div>
                            </div>

                            <div class="form-group text-lg-left">
                              <label for="k7">K<sub>7</sub></label>
                              <input class="form-control <?php echo form_error('n7') ? 'is-invalid':'' ?>"
                               type="number" name="k7" min="1" max="100" placeholder="Nilai Kriteria K7" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <!-- <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n7') ? 'is-invalid':'' ?>"
                               type="number" step="any" name="rating" min="0.0" hidden max="1.0" placeholder="Rating" />
                              <div class="invalid-feedback">
                                <?php echo form_error('n7') ?>
                              </div>
                            </div> -->
