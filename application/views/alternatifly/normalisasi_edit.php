    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="#services">Calculation</a></li>
          ...
          <div class=" wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><a href="">Normalisasi Data</a></h4>
               ...
               <p class="description">Pada Menu Normalisasi Data ini berisikan matriks pertama yang didapat dari hasil pencocokan rating pada menu alternatif data lalu, akan dicari nilai maksimal dari setiap kolom yang terdapat pada matriks pertama. Setelah semua didapat lalu cari nilai ternormalisasi dengan rumus Rii = ( Xij / max{Xij}) jika pada kolom benefit dan dengan rumus Rii = ( min{Xij} / Xij) jika pada kolom cost lalu hasilnya dimasukkan pada tabel ternormalisasi sehingga diperoleh matriks ternormalisasi.</p><br><br>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                      <div class="card-header text-lg-left">
                        ...
                        <a href="<?php echo site_url('normalisasi') ?>"><!-- <i class="fas fa-arrow-left"> --></i>
                          Back</a>
                      </div>
                      <div class="card-body">
                        ...
                        <form action="<?php echo site_url("welcome/normalisasi_edit/".$id);?>" method="post" enctype="multipart/form-data" >
                             <input type="hidden" name="id" value="<?php echo site_url("welcome/normalisasi_edit/".$id);?>" />
                            
                            <div class="form-group text-lg-left">
                              <!-- <label for="id">ID*</label> -->
                              <input class="form-control <?php echo form_error('id_alternatif') ? 'is-invalid':'' ?>"
                               type="text" name="id"  placeholder="ID Alternatif" hidden readonly value="<?php echo $id?>"/>
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('nama_alternatif') ? 'is-invalid':'' ?>"
                               type="hidden" name="nama_alternatif" placeholder="Nama Alternatif" value="<?php echo $nama_alternatif ?>"/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <label for="rating">Nilai Skor Akhir</label>
                              <input class="form-control"
                               type="number" step="any" name="rating" min="0.0" max="100.0" placeholder="Nilai Akhir" value="<?php echo $rating ?>"/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n1') ? 'is-invalid':'' ?>"
                               type="hidden" name="k1" min="1" max="100" placeholder="Nilai Kriteria K1" value="<?php echo $k1 ?>" required=""/>
                              <div class="invalid-feedback">
                                <?php echo form_error('n1') ?>
                              </div>
                            </div>
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n2') ? 'is-invalid':'' ?>"
                               type="hidden" name="k2" min="1" max="100" placeholder="Nilai Kriteria K2" value="<?php echo $k2 ?>" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n3') ? 'is-invalid':'' ?>"
                               type="hidden" name="k3" min="1" max="100" placeholder="Nilai Kriteria K3" value="<?php echo $k3 ?>" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n4') ? 'is-invalid':'' ?>"
                               type="hidden" name="k4" min="1" max="100" placeholder="Nilai Kriteria K4" value="<?php echo $k4 ?>" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n5') ? 'is-invalid':'' ?>"
                               type="hidden" name="k5" min="1" max="100" placeholder="Nilai Kriteria K5" value="<?php echo $k5 ?>" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n6') ? 'is-invalid':'' ?>"
                               type="hidden" name="k6" min="1" max="100" placeholder="Nilai Kriteria K6" value="<?php echo $k6 ?>" required=""/>
                              <div class="invalid-feedback">
                            ...
                            <div class="form-group text-lg-left">
                              <input class="form-control <?php echo form_error('n7') ? 'is-invalid':'' ?>"
                               type="hidden" name="k7" min="1" max="100" placeholder="Nilai Kriteria K7" value="<?php echo $k7 ?>" required=""/>
                              <div class="invalid-feedback">
