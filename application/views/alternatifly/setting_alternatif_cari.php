        ...
        <div class="row">
          ...
          <div class=" wow bounceInUp" data-wow-duration="1.4s">
            <div class="box1">
              ...
              <br>                
              <a class="btn btn-outline-info" style="text-align: center;" href="<?php echo base_url('setting_kriteria');?>">Lanjut ke Halaman Kriteria Data >>></a><br><br>
                    ...
                    <div id="content-wrapper">
                      ...
                      <div class="container-fluid">
                        ...
                        <!-- DataTables -->
                          <div class="card mb-3">
                            <div class="card-header text-lg-left">
                              ...
                              <a class="btn btn-success" href="<?php echo base_url('setting_alternatif_tambah') ?>"><i class="fa fa-plus modal-icon"></i> Tambah</a>
                                ...
                                <input type="text" name="nama_dicari" placeholder="Masukkan Nama Data">
                              </form>
                            </div>
                          <div class="card-body"> 
                          ...
                          <a class="btn btn-outline-info" style="text-align: center;" href="<?php echo base_url('setting_kriteria');?>">Lanjut ke Halaman Kriteria Data >>></a>
