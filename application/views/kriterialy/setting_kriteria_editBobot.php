                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                      <div class="card-header text-lg-left">
                        ...
                        <a class="btn btn-success" href="<?php echo site_url('setting_kriteria') ?>"><i class="fa fa-arrow-left modal-icon"></i>
                          Kembali</a>
                      </div>
                      <div class="card-body">

                          <?php 
                            foreach ($nilaib as $list) {
                              $id = $list['id'];
                              $bobot1 = $list['bobot1'];
                              $bobot2 = $list['bobot2'];
                              $bobot3 = $list['bobot3'];
                              ...
                              //print_r($list['id_kriteria']);die();
                          ?>
                        <form action="<?php echo site_url("welcome/setting_kriteria_editBobot/".$id);?>" method="post" enctype="multipart/form-data">
                          
                          <input type="hidden" name="id" value="<?php echo site_url("welcome/setting_kriteria_editBobot/".$id);?>" />


                            <!-- <input class="form-control <?php echo form_error('nama_kriteria') ? 'is-invalid':'' ?>"
                             type="text" name="nama_kriteria" placeholder="Nama Kriteria" readonly required="" value="<?php echo $nama_kriteria ?>" />
                            

                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot_kriteria" min="0.0" max="1.0" required="" readonly placeholder="Bobot Kriteria" value="<?php echo $bobot_kriteria ?>" /> -->
                          ...
                          <div class="form-group text-lg-left">
                            ...
                            <input class="form-control <?php echo form_error('id') ? 'is-invalid':'' ?>"
                             type="text" name="id" hidden placeholder="ID Bobot" value="<?php echo $id ?>" readonly/>
                            
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot1">Bobot K<sub>1</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot1" min="1.0" max="100.0" required="" placeholder="Bobot K1" value="<?php echo $bobot1*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot2">Bobot K<sub>2</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot2" min="1.0" max="100.0" required="" placeholder="Bobot K2" value="<?php echo $bobot2*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot3">Bobot K<sub>3</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot3" min="1.0" max="100.0" required="" placeholder="Bobot K3" value="<?php echo $bobot3*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot4">Bobot K<sub>4</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot4" min="1.0" max="100.0" required="" placeholder="Bobot K4" value="<?php echo $bobot4*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot5">Bobot K<sub>5</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot5" min="1.0" max="100.0" required="" placeholder="Bobot K5" value="<?php echo $bobot5*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot6">Bobot K<sub>6</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot6" min="1.0" max="100.0" required="" placeholder="Bobot K6" value="<?php echo $bobot6*100 ?>" />
                          </div>

                          <div class="form-group text-lg-left">
                            <label for="bobot7">Bobot K<sub>7</sub></label>
                            <input class="form-control <?php echo form_error('bobot_kriteria') ? 'is-invalid':'' ?>"
                             type="number" step="any" name="bobot7" min="1.0" max="100.0" required="" placeholder="Bobot K7" value="<?php echo $bobot7*100 ?>" />
                          </div>
