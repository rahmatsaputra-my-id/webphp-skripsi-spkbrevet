                      ...
                      <div class="card-body">
                          ...
                          <?php 
                            foreach ($nilai as $list) {
                              $id = $list['id'];
                              $nama_kriteria = $list['nama_kriteria'];
                            }

                              //print_r($list['id_kriteria']);die();
                          ?>
                        <form action="<?php echo site_url("welcome/setting_kriteria_edit/".$id);?>" method="post" enctype="multipart/form-data">
                          
                          <input type="hidden" name="id" value="<?php echo site_url("welcome/setting_kriteria_edit/".$id);?>" />
                          ...
                          <div class="form-group text-lg-left">
                            ...
                            <input class="form-control <?php echo form_error('id') ? 'is-invalid':'' ?>"
                             type="text" name="id" hidden placeholder="ID Kriteria" value="<?php echo $id ?>" readonly/>
                          ...
                          <div class="form-group text-lg-left">
                            ...
                            <input class="form-control <?php echo form_error('nama_kriteria') ? 'is-invalid':'' ?>"
                             type="text" name="nama_kriteria" placeholder="Nama Kriteria" required="" value="<?php echo $nama_kriteria ?>" />
                          ...
                          <div class="form-group text-lg-left">
                            <label class=" control-label">Atribut <span class="require">*</span></label>
