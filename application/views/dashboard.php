    ...
    <div class="container d-flex h-100">
      ...
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first ">
          ...
          <!-- <div>
            <a href="<?php echo base_url('register');?>" class="btn-services scrollto">Register</a>
          </div> -->
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              ...
              <ul>
                <li><i class="ion-android-checkmark-circle"></i> Menggunakan metode <var>Simple Additive Weighting</var>(SAW) yang simple dan akurat dalam perhitungan.</li>
                <li><i class="ion-android-checkmark-circle"></i> Mudah untuk digunakan dan mempunyai alur yang jelas dalam penggunaan aplikasi.</li>
                <li><i class="ion-android-checkmark-circle"></i> Tersedia fitur Alternatif Data, Kriteria Data, Normalisasi Data, Rangking Data.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box"><a href="<?php echo base_url('setting_kriteria');?>">
              <div class="icon" style="background: #e1eeff;"><i class="ion-ios-bookmarks-outline" style="color: #2282ff;"></i></div>
              <h4 class="title">1. Kriteria Data</h4></a>
              <p class="description">Merupakan penentuan bobot dari setiap kriteria yang telah ditentukan sebelumnya. Dalam penentuan bobot kriteria maka bobot nilai dari setiap kriteria dimasukkan kedalam fitur kriteria data.</p></a>
            </div>
          </div>

          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div class="box"><a href="<?php echo base_url('setting_alternatif');?>">
              <div class="icon" style="background: #fceef3;"><i class="ion-ios-analytics-outline" style="color: #ff689b;"></i></div>
              <h4 class="title" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">2. Alternatif Data</h4></a>
              <p class="description">Merupakan penentuan rating kecocokan setiap alternatif dengan setiap kriteria. Dalam penentuan rating kecocokan maka nilai dari setiap kriteria dimasukkan kedalam tabel rating kecocokan.</p></a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title">3. Normalisasi Data</h4>
              <p class="description">Menormalisasikan Matriks berdasarkan persamaan data alternatif yang telah disesuaikan dengan jenis atribut (atribut keuntungan maupun atribut biaya) sehingga diperoleh matriks ternormalisasi R.</p></a>
            </div>
          </div>          
        ...
        <div class="row">
          ...
          <div id="faq7" class="collapse col-lg-9 text-center text-lg-left cta-text" data-parent="#manual-list">
            ...
            <ul id="manual-list" class="wow fadeInUp container">
              ...
              <li>
                <a data-toggle="collapse" class="collapsed" href="#faq8">Tahap Pertama</i></a>
                <div id="faq8" class="collapse" data-parent="#manual-list">
                  <p class="cta-text">
                    Pada tahap awal yaitu penentuan rating kecocokan setiap alternatif data dengan setiap kriteria data. Pada Menu Alternatif Data.
                  </p>
                </div>
              </li>

              <li>
                <a data-toggle="collapse" href="#faq9" class="collapsed">Tahap Kedua</a>
              ...
              <li>
                <a data-toggle="collapse" href="#faq10" class="collapsed">Tahap Ketiga</a>
                <div id="faq10" class="collapse" data-parent="#manual-list">
                  <p>
                    Lalu tahap ketiga membuat Normalisasi Matriks berdasarkan persamaan yang disesuaikan dengan jenis atribut (atribut keuntungan maupun atribut biaya) sehingga diperoleh matriks ternormalisasi R. Pada Menu Normalisasi Data.
                  </p>
                </div>
              </li>

              <li>
                <a data-toggle="collapse" href="#faq11" class="collapsed">Tahap Keempat</a>
